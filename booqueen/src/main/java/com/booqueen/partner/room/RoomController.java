...
public class RoomController {
	...
	@RequestMapping(value = "/set-facilities.pdo", method = RequestMethod.GET)
	public String getFacilitiesPage(@ModelAttribute("hotel")HotelVO hotel, Model model, HttpSession session) {
		try {
