...
public class DateVO  {
	...
	public Map<String, Integer> today_info(DateVO DateVO) {
		...
		cal.set(Integer.parseInt(DateVO.getYear()), Integer.parseInt(DateVO.getMonth()), 1);
		...
		int search_year = Integer.parseInt(DateVO.getYear());
		int search_month = Integer.parseInt(DateVO.getMonth()) + 1;
	...
	public String toString() {
		return "DateVO [year=" + year + ", month=" + month + ", date=" + date + ", value=" + value + ", schedule="
				+ schedule + ", schedule_detail=" + schedule_detail + ", hotelDay=" + hotelDay + ", hotelName="
