                                ...
                                <div class="_4eb31e16e">
                                    ...
                                    <div data-testid="PostBookingCheckinCheckout" class="_1e97201db">
                                        ...
                                        <time class="_ab5ecce54 a7c1636554">
                                            <div class="ac6bdec376">${reservationVO.start_date_year}년 ${reservationVO.start_date_month}월 ${reservationVO.start_date_day}일 ${reservationVO.start_day}요일</div>
                                        ...
                                        <time class="_ab5ecce54 a7c1636554">
                                            <div class="ac6bdec376">${reservationVO.end_date_year}년 ${reservationVO.end_date_month}월 ${reservationVO.end_date_day}일 ${reservationVO.end_day}요일</div>
