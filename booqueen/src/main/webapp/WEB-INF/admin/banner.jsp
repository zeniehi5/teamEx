            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h4 class="mt-4">배너 관리</h4>                      
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body" style="text-align:center;">배너 등록</div>
                                    <!-- <div class="card-footer d-flex align-items-center justify-content-between"> -->
                                        <a class="small text-white stretched-link" href="bannerUpload.html"></a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th>서울</th>
                                            <th>www.naver.com</th>
                                            <td>&nbsp;&nbsp;<a class="btn btn-danger" href="bannerCorrection.html">수정 및 삭제</a></td>
                                        </tr>
                                        <tr>
                                            <th>2</th>
                                            <th>대구</th>
