			...
			<main>
				<div class="container-fluid px-4">
						...
						<div class="col-xl-3 col-md-6">
							<div class="card bg-primary text-white mb-4">
								<div class="card-header card-header-success card-header-icon">
									...
									<h3 class="card-title"><small>${fn:length(userList)}명</small></h3>
								</div>
						...
						<div class="col-xl-3 col-md-6">
							<div class="card bg-warning text-white mb-4">
								<div class="card-header card-header-info card-header-icon">
									...
									<h3 class="card-title"><small>${joined_yesterday+0}명</small></h3>
								</div>
								<div class="card-footer">
									<div class="stats"><i class="material-icons" style="font-size: 0.875em;">매일 0시 초기화</i></div>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="card bg-success text-white mb-4">
								<div class="card-header card-header-info card-header-icon">
									...
									<h3 class="card-title"><small>${joined_today+0}명</small></h3>
								</div>
								<div class="card-footer">
									<div class="stats"><i class="material-icons" style="font-size: 0.875em;">매일 0시 초기화</i></div>
								</div>
						...
						<div class="col-xl-3 col-md-6">
							<div class="card bg-info text-white mb-4">
								<div class="card-header card-header-info card-header-icon">
									...
									<h3 class="card-title"><small>${block_user+0}명</small></h3>
								</div>
					...
					<div class="row">
						<div class="col-xl-6">
							<div class="card mb-4">
								<div class="card-header"><i class="fas fa-chart-bar me-1"></i>가입자 연령</div>
								<div class="card-body"><canvas id="myBarChart" width="100%" height="40"></canvas></div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="card mb-4">
								<div class="card-header"><i class="fas fa-chart-pie me-1"></i>남녀비율</div>
								<div class="card-body"><canvas id="myPieChart" width="100%" height="40"></canvas></div>                  
							</div>
						</div>
					</div>
					<div class="card mb-4">
						<div class="card-header"><i class="fas fa-table me-1"></i>회원 목록</div>
						<div class="card-body">
