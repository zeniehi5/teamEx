			...
			<main>
				<div class="container-fluid px-4">
        			...
        			<div class="col-lg-6" style="width: 100%;">
        				<div class="card mb-4">
        					<div class="card-header" style="font-size: 20px;"><i class="fas fa-chart-pie me-1"></i>지급 현황</div>
        					<div class="card-body"><canvas id="myPieChart" width="100%" height="40"></canvas></div>
        				</div>
        			</div>
        			<div class="card mb-4">
    	    			<div class="card-header" style="font-size: 20px;"><i class="fas fa-table me-1"></i>지급 목록</div>
    	    			<div class="card-body">
    	    				<table id="datatablesSimple">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="dataTable-dropdown" style="display: flex; flex-direction: row;">
