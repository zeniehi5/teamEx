...
<body>
    ...
    <div class="next-trip">
        <div class="next-trip-content">
            <div class="next-trip-h1"><h1>다음에 머무를 숙소를 알아보세요!</h1><i class="far fa-paper-plane fa-3x"></i></div>
        ...
        <form class="main-form" action="${contextPath}/searchResult.do">
            <div class="form-inner">
                ...
                <div class="form-inner-third">
                    <div>
                        <input type="number" placeholder="인원" class="number-of-member" name="quantity">
                    </div>
                </div>
