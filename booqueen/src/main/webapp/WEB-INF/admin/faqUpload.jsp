...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="card mb-4">
                            ...
                            <tr>
                                ...
                                <div style="float:right">
                                    ...
                                    <a href="faq.html" class="btn btn-warning">돌아가기</a>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script src="${contextPath}/resources/admin/javascript/datatables-simple-demo.js
"></script>
    </body>
</html>
