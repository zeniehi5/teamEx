				...
				<div class="container-fluid px-4" style="padding-top: 1.5rem;">     
					<div class="card mb-4" style="border: none;">
						<div class="card-header">
							<div class="col three">
								<div style="font-size: 20px; font-weight: bold;">회원 정보</div>
							</div>
						</div>
						<div class="card-body">
							<form action="" name="goodsForm" method="POST" enctype="multipart/form-data">
								...
								<br>
								<div class="card mb-4">
									<div class="card-header"><i class="fas fa-table me-1"></i>호텔 이용내역</div>
									<div class="card-body">
											...
											<tbody>
												<c:forEach var="userVO" items="${userVO}" varStatus="status">
													...
													<tr>
														...
														<c:choose>
														<c:when test="${userVO.use_status eq 1}"><td>체크인 중</td></c:when>
														<c:when test="${userVO.use_status eq 2}"><td>이용 완료</td></c:when>
														<c:otherwise><td>예약 완료</td></c:otherwise>
														</c:choose>
													</tr>
													</c:when>
													<c:otherwise>
													<tr>
														<td colspan='5' style="border: none;"><span><strong>호텔 이용 내역이 없습니다</strong></span></td>
													</tr>
													</c:otherwise>
													</c:choose>
												</c:forEach>
