...
<script>
   ...
   function submitForm(){
	   ...
	   var checked = $("#terms1").is(":checked");
	   var checked2 = $("#terms2").is(":checked");
...
<body>
   ...
   <main class="contents">
      ...
      <form id="myForm" action="payment.pdo" method="post">
      <div class="input">
      ...
      <div class="last">
         ...
         <div class="check">
            ...
            <label><input id="terms1" type="checkbox"> 본 숙박 업체는 합법적인 사업자로,
               ...
               type="checkbox" id="terms2"> <a href="#">일반 계약 조건</a>과 <a href="#">개인정보
